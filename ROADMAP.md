...
Phased plan. Phases 1 and 2 are implemented in `0.1.0`, together with the
opt-in heuristic detectors, the `tokenize` action and the Anthropic wrapper
originally planned for Phases 3 and 4. The remaining items are tracked below.
...
## Phase 2 — First adapter + first LLM wrapper — done in 0.1.0
